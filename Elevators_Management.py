...
#from game import pack_elevators_to_desplay
import pygame
...
class Elevators_Management:
    ...
    def __init__(self, floors = 8, elevators = 12):
        self.__num_of_floors = floors
        self.__num_of_elevators = elevators
  
        self._the_elevators = [Elevator(i,0,i) for i in range(self.__num_of_elevators)]
